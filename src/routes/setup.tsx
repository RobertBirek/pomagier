      ...
      <div className="mx-auto max-w-2xl px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Instrukcja pierwszego uruchomienia na urządzeniach
          </p>
        </div>

        <Section number={1} title="Bezpieczeństwo" icon={<Globe className="h-5 w-5" />}>
          <p className="text-sm text-muted-foreground">
            Aplikacja używa certyfikatu <strong>Let's Encrypt</strong> — automatycznie odnawianego,
            zaufanego przez wszystkie przeglądarki i systemy operacyjne.
          </p>
          <div className="mt-3 rounded-lg bg-success/10 p-3 text-sm text-success flex items-start gap-2">
            <CheckCircle2 className="h-4 w-4 shrink-0 mt-0.5" />
            <span>
              <strong>Nie musisz instalować certyfikatów ręcznie.</strong> Domena jest w pełni
              zaufana na Android, iOS, Windows, Zebra.
            </span>
          </div>
        </Section>
        ...
        <Section number={2} title="Otwórz aplikację" icon={<Globe className="h-5 w-5" />}>
          ...
          <p className="text-xs text-muted-foreground mt-2">
            Działa na wszystkich urządzeniach w sieci lokalnej i przez internet.
          </p>
        </Section>
        ...
        >
          <ol className="list-decimal space-y-2 pl-5 text-sm">
            <li>
              Otwórz{" "}
              <code className="rounded bg-muted px-1 font-mono text-xs">https://{DOMAIN}</code> w{" "}
              <strong>Chrome</strong>
            </li>
            <li>
              Menu (⋮) → <strong>"Dodaj do ekranu głównego"</strong> lub{" "}
          ...
          <div className="space-y-3">
            <div>
              ...
              <ol className="list-decimal space-y-1 pl-5 text-sm">
                <li>
                  Otwórz <strong>DataWedge</strong> (preinstalowana)
                </li>
                <li>
                  Nowy profil → <strong>Input</strong>: Barcode włączone
                </li>
                <li>
                  <strong>Output</strong>: Keystroke włączone → dodaj <strong>Enter</strong> jako
                  suffix
                </li>
                <li>
            ...
            <div>
              ...
              <ol className="list-decimal space-y-1 pl-5 text-sm">
                <li>
                  Otwórz{" "}
                  <code className="rounded bg-muted px-1 font-mono text-xs">https://{DOMAIN}</code>{" "}
                  w Chrome
                </li>
                <li>
                  Menu → <strong>Zainstaluj aplikację</strong>
                </li>
              </ol>
            </div>
          </div>
        ...
        <Section number={5} title="Windows" icon={<Monitor className="h-5 w-5" />}>
          <ol className="list-decimal space-y-1 pl-5 text-sm">
            ...
            <li>
              Pasek adresu → ikona ⊕ → <strong>Zainstaluj</strong>
            </li>
        ...
        <div className="mt-8 rounded-lg border bg-card p-6">
          ...
          <FaqItem
            title="Nie mogę znaleźć domeny"
            description={`Sprawdź połączenie z internetem. Domena ${DOMAIN} wymaga dostępu do sieci.`}
          />
          <FaqItem
            title="Kamera nie działa"
            description="Kamera wymaga HTTPS. Let's Encrypt zapewnia zaufany certyfikat — jeśli widzisz ostrzeżenie, odśwież stronę."
          />
          <FaqItem
            title="Nie mogę się zalogować"
            description="Domyślny PIN to 0000. Administrator może zmienić PIN w panelu administracyjnym."
          />
          <FaqItem
            title="Aplikacja działa wolno"
            description="Pierwsze uruchomienie może trwać kilka sekund. Service Worker cachuje aplikację do pracy offline."
          />
        </div>
      </div>
    </div>
