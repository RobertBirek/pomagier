...
export function MobileShell() {
  ...
  const { isLandscape, unsupported, angle } = useScreenOrientation();
  ...
  const forcePortraitStyle =
    isLandscape && angle !== 0
      ? ({
          ...
          width: "100vh",
          height: "100vw",
          top: angle === 90 ? 0 : "100vh",
          left: angle === 90 ? "100vw" : 0,
  ...
  return (
    <div className="flex min-h-screen flex-col bg-muted/50" style={forcePortraitStyle}>
      {!hideChrome && (
