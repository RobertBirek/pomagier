...
- [x] v1.10.1 — 49 pre-existing prettier errors fixed + SyncStatusBadge on /admin/map, 297 testów
- [x] v1.10.4 — Dashboard analytics: taby operacyjne/systemowe, zakresy dat, auto-refresh, 297 testów
